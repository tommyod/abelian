...
def test_elements_of_maxnorm_num_elements():
    """
...
def test_elements_of_maxnorm_increasing_norm():
    """
...
def test_im_coim(free_to_free_setup):
    """
    Test the image/coimage factorization of A.
    """
    A, A_ker, A_coker, A_im, A_coim, A_quotient = free_to_free_setup

    assert A_im * A_coim == A


def test_kernel(free_to_free_setup):
    """
...
def test_cokernel(free_to_free_setup):
    """
