...
def test_bijective_free_to_free(setup_test_solve_Epi):
    """
    Solve X*A = B when A is a bijective, free-to-free morphism.
    """
    m, k = setup_test_solve_Epi
...
def test_epi_free_to_free(setup_test_solve_Epi):
    """
...
def test_surjective(setup_test_solve):
    """
...
def test_injective(setup_test_solve):
    """
    Test the equation solver when a is surjective,
...
def test_lower_rank_mapping(setup_test_solve):
    """
