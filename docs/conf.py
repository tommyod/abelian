...
if on_rtd:
    ...
    module_dir = os.path.join(__location__, "../abelian")
...
exclude_patterns = ['_build', 'tests', 'notebooks/.ipynb_checkpoints']
...
try:
    from abelian import __version__ as version
except ImportError:
    pass
else:
    release = version
